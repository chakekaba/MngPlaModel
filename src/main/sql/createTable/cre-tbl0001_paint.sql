...
comment on column tbl0001_paint.visible is '画面表示:0:非表示、1:表示';


-- サンプルデータ追加
insert into tbl0001_paint (paintcode, distributor, brand, color, painttype, possession, visible) values ('XF-25', 'タミヤ', 'タミヤカラー', 'ライトシーグレイ', '1', '1', '1');
insert into tbl0001_paint (paintcode, distributor, brand, color, painttype, possession, visible) values ('XF-1', 'タミヤ', 'タミヤカラー', 'フラットブラック', '1', '1', '1');
